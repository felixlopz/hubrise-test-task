  ...
  return (
    <>
      <div className="header-mobile">
        <div className="header-mobile__button" onClick={() => setIsMenuOpen(true)}>
      ...
      <div className="mobile-bar">
        ...
        >
          <header className="mobile-bar__header" onClick={() => setIsMenuOpen(false)}>
          ...
          <div className="mobile-bar__nav">
            ...
            <Link className="mobile-bar__login" to="https://manager.hubrise.com/login" newTab={false}>
