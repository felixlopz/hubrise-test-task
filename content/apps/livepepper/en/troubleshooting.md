...
![List missing POS Codes](../images/020-missing-pos-codes.png)
...
5. The **Logs** section will contain the detailed JSON records of the communication between LivePepper and HubRise. For more information on how to read these logs, see How to read a JSON request.
