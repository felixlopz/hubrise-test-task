...
To receive Just Eat orders in AKK Softtech via Takeaway API, you first need to connect Just Eat Takeaway Bridge, an app included in your HubRise subscription. For more information about Just Eat Takeaway Bridge, see the [Just Eat Takeaway Bridge documentation](/apps/just-eat-takeaway).
...
To receive Just Eat orders in AKK Softtech via Flyt API, you first need to connect Just Eat Flyt Bridge, an app included in your HubRise subscription. For more information about Just Eat Flyt Bridge, see the [Just Eat Flyt Bridge documentation](/apps/just-eat-flyt).
...
**IMPORTANT NOTE:** Preparation notes on individual items are not supported in AKK Softtech. If you rely on these comments for cooking or serving instructions (for example, "Medium cooking", or "Cut in slices"), you need to replace them by options in your Uber Eats menu.
