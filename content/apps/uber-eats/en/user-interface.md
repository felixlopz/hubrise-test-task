...
meta:
  ...
  description: How to navigate the Uber Eats Bridge main page to access information about the orders and customise the behaviour of the bridge.
---

From the main page of the Uber Eats Bridge, you can read the logs of all the operations between HubRise and Uber Eats, and access the configuration settings of the integration.
...
Selecting an order operation from the list in the main page will display all the logs of the API requests exchanged between HubRise and Uber Eats via the Uber Eats Bridge.
...
Clicking on the Uber Eats and HubRise logos on top of any page of the Uber Eats Bridge will bring you back to the main page.
...
From this page, you will be able to customise the behaviour of the Uber Eats Bridge. For more details, see [Configuration](/apps/uber-eats/configuration).
